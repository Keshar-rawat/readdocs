...
from readdocs.utils import loggerutil
from readdocs.utils.singleton import Singleton
...
class DataSource(metaclass=Singleton):
    def __init__(self):
        ...
        """
        try:
            self.engine = create_engine(Settings.DATABASE_URL, pool_size=20, max_overflow=30, pool_timeout=60,
                                        pool_recycle=3600)
            self.ping()
